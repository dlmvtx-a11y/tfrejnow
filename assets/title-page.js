        ...
        '<div class="flex flex-col md:flex-row gap-8 lg:gap-14 w-full">' +
            ...
            '<div class="flex flex-col justify-center flex-1 text-center md:text-left min-w-0">' +
                ...
                '<div class="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-12">' +
                    ...
                    '<button onclick="App.createWatchParty()" class="flex items-center gap-2 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 border border-black/10 dark:border-white/10 text-black dark:text-white px-6 py-4 rounded-xl font-bold text-base md:text-lg"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Watch Together</button>' +
                '</div>' +
